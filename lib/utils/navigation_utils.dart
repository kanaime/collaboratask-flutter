...
//endregion
  ...
  /// Navigue vers l'écran en paramètres en presentation modale
  /// fade in pour android, from bottom pour ios
  /// Retour arrière sur l'écran en cours possible
  /// return le result dynamic
  Future<dynamic> presentScreen(BuildContext context, Widget viewController) async {
    if (Platform.isIOS) {
      ...
      return await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => viewController, fullscreenDialog: true),
      );
    }
  }
}
